    ...
    <div class="window_box_container">
        <div class="account_window">
            <div class="account_title_container">
                ...
                <span><h1><?php echo $account->firstname. ' ' .$account->lastname ?> </h1></span>
            </div>
            <form class="account_panel">
                <h3>Personal Data</h3>
                <h5><label for="email">Email: <?php echo $account->email?></label><br></h5>
                <h5><label for="telephone">Telephone: <?php echo $account->telephone?></label><br></h5>
                <h5><label for="address">Address: <?php echo $account->address?></label><br></h5>
